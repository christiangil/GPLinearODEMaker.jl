...
function pp_kernel(
    ...
    if dorder_view==[5, 2]
        func = -19200*abs_δ^2*dabs_δ^5/λ^9 - 6000*abs_δ*(5*dabs_δ/λ + 16*abs_δ*dabs_δ/λ^2)/λ^7 - 288000*dabs_δ^5*(1 - abs_δ/λ)^2/λ^7 + 1200*abs_δ*(-5*dabs_δ/λ^2 - 32*abs_δ*dabs_δ/λ^3)/λ^6 + 12000*(1 - abs_δ/λ)*(5*dabs_δ/λ + 16*abs_δ*dabs_δ/λ^2)/λ^6 - 4800*(1 - abs_δ/λ)*(-5*dabs_δ/λ^2 - 32*abs_δ*dabs_δ/λ^3)/λ^5 + 600*(1 - abs_δ/λ)*(10*dabs_δ/λ^3 + 96*abs_δ*dabs_δ/λ^4)/λ^4 - 120*(48*abs_δ^2/λ^4 + 10*abs_δ/λ^3)*dabs_δ^5/λ^5 + 1200*(-16*abs_δ^2/λ^3 - 5*abs_δ/λ^2)*dabs_δ^5/λ^6 - 3600*(1 + 8*abs_δ^2/λ^2 + 5*abs_δ/λ)*dabs_δ^5/λ^7 + 230400*abs_δ*dabs_δ^5*(1 - abs_δ/λ)/λ^8
    end
    ...
    if dorder_view==[5, 1]
        func = 600*abs_δ*(5*dabs_δ/λ + 16*abs_δ*dabs_δ/λ^2)/λ^6 + 48000*dabs_δ^5*(1 - abs_δ/λ)^2/λ^6 - 2400*(1 - abs_δ/λ)*(5*dabs_δ/λ + 16*abs_δ*dabs_δ/λ^2)/λ^5 + 600*(1 - abs_δ/λ)*(-5*dabs_δ/λ^2 - 32*abs_δ*dabs_δ/λ^3)/λ^4 - 120*(-16*abs_δ^2/λ^3 - 5*abs_δ/λ^2)*dabs_δ^5/λ^5 + 600*(1 + 8*abs_δ^2/λ^2 + 5*abs_δ/λ)*dabs_δ^5/λ^6 - 19200*abs_δ*dabs_δ^5*(1 - abs_δ/λ)/λ^7
    end
    ...
    if dorder_view==[5, 0]
        func = -9600*dabs_δ^5*(1 - abs_δ/λ)^2/λ^5 + 600*(1 - abs_δ/λ)*(5*dabs_δ/λ + 16*abs_δ*dabs_δ/λ^2)/λ^4 - 120*(1 + 8*abs_δ^2/λ^2 + 5*abs_δ/λ)*dabs_δ^5/λ^5
    end
